...
import static com.vocabulary.ActivityVocabularyContainer.optionsRefresh;
import static com.vocabulary.ActivityVocabularyList.KEY_CODE_OF_VOCABULARY;
...
public class ListViewAdapter2 extends BaseAdapter {
    ...
    public ListViewAdapter2(Context context, ArrayList<Word> wordList, boolean selectable, int i) {
        ...
        if (vocabularies.get(i).isContainer())
        {
            ...
            holder.tvVocabularyIn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    dataBundle.putInt(KEY_VOCABULARY_ID, holder.word.getVocabularyIn().getID());
