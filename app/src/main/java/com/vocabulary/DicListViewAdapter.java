...
import static com.vocabulary.Data.getIndexOfSubject;
import static com.vocabulary.Data.languageTillIndex;
...
public class DicListViewAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (!dicList.get(position).isContainer()) {
            ...
            holder.tvNumberOfWords = (TextView) row.findViewById(R.id.tv_num_of_phrases);
